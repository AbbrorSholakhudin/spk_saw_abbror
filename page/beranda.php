...
<div class="panel">
    <div class="panel-middle text-center">
        <h1>
            ...
            di Sistem Pendukung keputusan pemilihan toko terbaik dari produk yang berbeda berbasis web menggunakan metode <span class="text-green">Simple Additive Weighting (SAW)</span>
        </h1>
    </div>
